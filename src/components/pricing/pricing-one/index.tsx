...
const PricingOne = () => {
  return (
    <div className="mb-12 p-4 bg-gray-50">
      <h3 className="text-xl font-normal tracking-wide">DESIGN ONE</h3>
      <div className="flex flex-col justify-center items-center ">
        ...
        <div className="flex space-x-4 h-96">
          <Pricing title="Basic" size="base" price="$100.00"/>
          <Pricing title="Professional" size="large" price="$200.00"/>
          <Pricing title="Enterprise" size="base" price="$300.00"/>
        </div>
      </div>
    </div>
  );
